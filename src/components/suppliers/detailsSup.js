...
const DetailsSup = () => {
  ...
  const onDelete = () => {
    try {
      ...
      setVisible(false);
      toast.warning(`Supplier : ${supplier.name} is deleted `);
  ...
  return (
    <div>
      <PageTitle title=" Back " subtitle={`Supplier Information ${supplier.name} `} />
          ...
          <Fragment key={supplier.id}>
            <Card bordered={false} style={{}}>
              ...
              <div className="mt-3 mb-3">
                ...
                <p>
                  <Typography.Text strong>Amount to be paid :</Typography.Text>{" "}
                  {supplier.due_amount}
                </p>
              </div>
              <hr />
              <h6 className="font-semibold m-0 text-center">
              All information on the invoice
              </h6>
