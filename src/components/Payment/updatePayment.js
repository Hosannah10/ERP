...
function UpdateSup() {
  ...
  const onFinish = (values) => {
    try {
      ...
      setSuccess(true);
      toast.success("Supplier details are updated");
      setInitValues({});
    } catch (error) {
      console.log(error.message);
    }
            ...
            <Row className='mr-top'>
              ...
              >
                {success && (
                  <div>
                    <Alert
                      message={`Supplier details have been successfully updated`}
                      type='success'
                      closable={true}
                      showIcon
                    />
                      ...
                      rules={[
                        {
                          type: Number,
                          required: true,
                          message: "Please enter the supplier amount!",
                        },
                      ]}
                    >
