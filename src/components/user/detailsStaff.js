...
const DetailStaff = () => {
  ...
  const onDelete = () => {
    try {
      ...
      setVisible(false);
      toast.warning(`username : ${user.username} is deleted `);
          ...
          <Fragment key={user.id}>
            <Card bordered={false} className="card-custom">
              ...
              <div className="card-body m-3">
                ...
                <p>
                  <Typography.Text strong>phone number :</Typography.Text> {user.phone}
                </p>
                <p>
                ...
                <p>
                  <Typography.Text strong>Start date of function</Typography.Text>{" "}
                  {moment(user.join_date).format("YYYY-MM-DD")}
                </p>

                <p>
                  <Typography.Text strong>End date of function</Typography.Text>{" "}
